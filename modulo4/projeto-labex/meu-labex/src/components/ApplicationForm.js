...
function ApplicationForm() {
    ...
    const ApplyToTrip = (tripId) => {
        ...
        axios.post(`https://us-central1-labenu-apis.cloudfunctions.net/labeX/Jose-Barros/trips/${tripId}/apply`, body, {
            headers: {
    ...
    const GetTrips = () => {
        axios.get("https://us-central1-labenu-apis.cloudfunctions.net/labeX/Jose-Barros/trips")
        .then((response) => {
